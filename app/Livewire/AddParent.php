...
class AddParent extends Component
{
    ...
    public function firstStepSubmit()
    {
        $this->validate([
            ...
            'Passport_ID_Father' => 'nullable|unique:my__parents,Passport_ID_Father,' ,
            'Phone_Father' => 'required|regex:/^([0-9\s\-\+\(\)]*)$/|min:10',
    ...
    public function secondStepSubmit()
    {
        $this->validate([
            ...
            'Passport_ID_Mother' => 'nullable|unique:my__parents,Passport_ID_Mother,' ,
    ...
    public function submitForm_edit()
    {
        ...
        $this->show_table = true;
        $this->successMessage = trans('message.update');
    }
    ...
    public function delete($id)
{
    ...
    // هات كل الملفات الخاصة بالأب
    $attachments = ParentAttachment::where('parent_id', $parent->id)->get();

    foreach ($attachments as $attachment) {
        // مسح الملف من التخزين
        Storage::disk('parent_attachments')->delete(
            $parent->National_ID_Father . '/' . $attachment->file_name
        );
    ...
    $this->show_table = true;
    $this->successMessage = trans('message.delete');
}
