                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50" style="text-align: center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="alert-danger">{{ __('Students_trans.previous_grade_level') }}</th>
                                            <th class="alert-danger">{{ __('Students_trans.academic_year') }}</th>
                                            <th class="alert-danger">{{ __('Students_trans.previous_classroom') }}</th>
                                            <th class="alert-danger">{{ __('Students_trans.previous_section') }}</th>
                                            <th class="alert-success">{{ __('Students_trans.current_grade_level') }}</th>
                                            <th class="alert-success">{{ __('Students_trans.current_academic_year') }}</th>
                                            <th class="alert-success">{{ __('Students_trans.current_classroom') }}</th>
                                            <th class="alert-success">{{ __('Students_trans.current_section') }}</th>
