                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('Fees.store') }}" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputZip">{{ trans('Fees.classrooms') }}</label>
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="Fees_type">
                                    <option value="1">{{ trans('Fees.amount_stu') }}</option>
                                    <option value="2">{{ trans('Fees.Bus') }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary">{{ trans('Fees.Finish') }}</button>
