...
@section('css')
    @toastr_css
@section('title')
    {{ __('Teacher_trans.edit_quiz') }} {{$quizz->name}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{route('qui_tea.update',$quizz->id)}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="form-row">

                                    <div class="col">
                                        <label for="title">{{ __('Teacher_trans.quiz_name_ar') }}</label>
                                        <input type="text" name="Name_ar" value="{{$quizz->getTranslation('name','ar')}}" class="form-control">
                                    </div>

                                    <div class="col">
                                        <label for="title">{{ __('Teacher_trans.quiz_name_en') }}</label>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id">{{ __('Teacher_trans.subject') }} : <span class="text-danger">*</span></label>
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{ __('Teacher_trans.confirm_data') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
