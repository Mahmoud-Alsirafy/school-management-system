...
@section('css')
    @toastr_css
@section('title')
    {{ __('Teacher_trans.edit_question') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{ __('Teacher_trans.edit_question') }} :<span class="text-danger">{{$question->title}}</span>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('questions.update',$question->id) }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{ __('Teacher_trans.question_name') }}</label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{ __('Teacher_trans.right_answer') }}</label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id">{{ __('Teacher_trans.score') }} : <span class="text-danger">*</span></label>
                                            <select class="custom-select mr-sm-2" name="score">
                                                <option selected disabled>{{ __('Teacher_trans.select_score') }}</option>
                                ...
                                <br>
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{ __('Teacher_trans.save_data') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
