...
@toastr_css
@section('title')
{{ __('Teacher_trans.attendance_list_title') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
...
<h5 style="font-family: 'Cairo', sans-serif;color: red"> {{ __('Teacher_trans.today_date') }} : {{ date('Y-m-d') }}</h5>
    ...
    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
        ...
        <thead>
            <tr>
                ...
                <th class="alert-success">{{ __('Teacher_trans.attendance_absence') }}</th>
            </tr>
        </thead>
        <tbody>
                ...
                <td>
                    <label class="block text-gray-500 font-semibold sm:border-r sm:pr-4">
                        <input name="attendences[{{ $student->id }}]"
                               ...
                               value="presence">
                        <span class="text-success">{{ __('Teacher_trans.presence') }}</span>
                    </label>
                    ...
                    <label class="ml-4 block text-gray-500 font-semibold">
                        <input name="attendences[{{ $student->id }}]"
                               ...
                               class="leading-tight" type="radio"
                               value="absent">
                        <span class="text-danger">{{ __('Teacher_trans.absent') }}</span>
                    </label>
