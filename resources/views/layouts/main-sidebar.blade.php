                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('Sections.index') }}">{{ trans('main_trans.sections') }} </a> </li>
                        </ul>
                    </li>
                        ...
                        <ul id="students-menu" class="collapse">
                            <li>
                                ...
                                <ul id="Student_information" class="collapse">
                                    ...
                                    <li> <a href="{{ route('Students.index') }}">{{ trans('main_trans.Student_list')
                                            }}</a> </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul id="Students_upgrade" class="collapse">
                                    <li> <a href="{{route('Promotion.index')}}">{{ trans('main_trans.Promotion') }}</a>
                                    </li>
                                    <li> <a href="{{route('Promotion.create')}}">{{
                                            trans('main_trans.Managment_Promotions') }}</a> </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul id="Graduate students" class="collapse">
                                    <li> <a href={{ route('Graduated.create')
                                            }}>{{trans('main_trans.add_Graduate')}}</a> </li>
                                    <li> <a href={{ route('Graduated.index')
                                            }}>{{trans('main_trans.list_Graduate')}}</a> </li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Subject-icon">
                            <div class="pull-left"><i class="fas fa-calendar-alt"></i><span
                                    class="right-nav-text">{{trans('subject.subject')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Subject-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('subjects.index') }}">{{trans('subject.subject')}}</a> </li>
                            <li> <a href="{{ route('subjects.create') }}">{{trans('subject.add_subject')}}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('Quizzes.index') }}">{{ trans('quizze.quizzes') }}</a> </li>
                            <li> <a href="{{ route('Question.index') }}">{{ trans('Question.Question') }}</a> </li>
                        </ul>
                    </li>
